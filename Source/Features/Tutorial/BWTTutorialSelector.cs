...
namespace Better_Work_Tab.Features.Tutorial
{
    internal sealed class BWTTutorialHubDefinition
    {
            ...
            IList<BWTTutorialOptionDefinition> options)
        {
            ...
            Options = options ?? ArrayCompat.Empty<BWTTutorialOptionDefinition>();
        }
    ...
    internal sealed class BWTTutorialSelector
    {
        ...
        internal void Reset()
        {
            ...
            lastOptionsRect = Better_Work_Tab.RectCompat.Zero;
            lastContextRect = Better_Work_Tab.RectCompat.Zero;
            ...
            string leaveLabel)
        {
            ...
            Better_Work_Tab.WidgetsCompat.DrawBoxSolid(layout.PanelRect, new Color(0.055f, 0.062f, 0.07f, 0.98f));
            ...
            for (int i = 0; i < hub.Options.Count && i < layout.OptionRects.Count; i++)
            {
                ...
                Better_Work_Tab.WidgetsCompat.DrawBoxSolid(rect, isHovered
                ...
                string prefix = isComplete ? "âœ“  " : string.Empty;
            ...
            Better_Work_Tab.WidgetsCompat.DrawBoxSolid(layout.ContextRect, new Color(0.075f, 0.082f, 0.09f, 0.98f));
            ...
            Better_Work_Tab.WidgetsCompat.DrawBoxSolid(layout.ExitRect, exitHovered
            ...
            Better_Work_Tab.WidgetsCompat.DrawBoxSolid(layout.LeaveRect, leaveHovered
                ? new Color(0.20f, 0.18f, 0.11f, 1f)
                : new Color(0.10f, 0.11f, 0.12f, 1f));
        ...
        private static void DrawFocusDim(Rect workBounds, Rect focusRect)
        {
            ...
            Better_Work_Tab.WidgetsCompat.DrawBoxSolid(new Rect(workBounds.xMin, workBounds.yMin, workBounds.width,
                Mathf.Max(0f, focus.yMin - workBounds.yMin)), dim);
            Better_Work_Tab.WidgetsCompat.DrawBoxSolid(new Rect(workBounds.xMin, focus.yMax, workBounds.width,
                Mathf.Max(0f, workBounds.yMax - focus.yMax)), dim);
            Better_Work_Tab.WidgetsCompat.DrawBoxSolid(new Rect(workBounds.xMin, focus.yMin,
                Mathf.Max(0f, focus.xMin - workBounds.xMin), focus.height), dim);
            Better_Work_Tab.WidgetsCompat.DrawBoxSolid(new Rect(focus.xMax, focus.yMin,
            ...
            TutorialHubAnchor kind)
        {
            ...
            return Better_Work_Tab.RectCompat.Zero;
        }
        ...
        private static string GetOptionDisplayLabel(BWTTutorialOptionDefinition option, string recommendedLabel)
        {
            return option.Recommended
                ? option.Label + "  Â· " + recommendedLabel
                : option.Label;
        }

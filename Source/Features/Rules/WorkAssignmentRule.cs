    ...
    public class WorkAssignmentRule : IExposable
    {
        ...
        )
        {
            ...
            WorkPrioritySystem.SetPriority(
                Better_Work_Tab.PawnCompat.WorkSettings(pawn),
                assigningWorktype,
                Parameters.Priority);
        ...
        public void ExposeData()
        {
            ...
            Better_Work_Tab.ScribeCompat.LookValue(ref CachedWorktypeString, "Worktype");
#if !vAlpha4
            ...
            {
                CachedWorktypeString = CachedWorktypeString ?? string.Empty;

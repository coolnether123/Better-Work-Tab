...
namespace Better_Work_Tab.ModSupport.Mods.FluffyWorkTab
{
    internal static class FluffyWorkTabCoexistenceUI
    {
        ...
        internal static void DrawWorkTabSwitchButton(Rect inRect)
        {
            ...
            if (Better_Work_Tab.WidgetsCompat.ButtonText(buttonRect, "BWT_UseFluffyWorkTab_Button".Translate()))
            {
        ...
        internal static void DrawSettingsBannerIfNeeded(ref Rect inRect)
        {
            ...
            Better_Work_Tab.WidgetsCompat.DrawBoxSolid(bannerRect, new Color(0.18f, 0.18f, 0.18f, 0.95f));
            ...
            if (Better_Work_Tab.WidgetsCompat.ButtonText(buttonRect, "BWT_SwitchBackToBetterWorkTab_Button".Translate()))
            {

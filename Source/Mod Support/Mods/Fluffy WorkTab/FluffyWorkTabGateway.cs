...
namespace Better_Work_Tab.ModSupport.Mods.FluffyWorkTab
{
    ...
    internal static class FluffyWorkTabGateway
    {
        ...
        private static void DrawChoiceButton(Rect rect, string caption, bool forceHover)
        {
            ...
            Better_Work_Tab.WidgetsCompat.ButtonText(rect, "BWT_SubWork_Chooser_UseThisView".Translate());
        ...
        private static void ClearSubWorkDrilldownStyleChooser(bool clearPreview = true)
        {
            ...
            _chooserSourceRect = Better_Work_Tab.RectCompat.Zero;
            _chooserSourceWorkColumnSlot = -1;
            _focusChoiceRegionRect = Better_Work_Tab.RectCompat.Zero;
            _expandChoiceRegionRect = Better_Work_Tab.RectCompat.Zero;
            _focusChoiceButtonRect = Better_Work_Tab.RectCompat.Zero;
            _expandChoiceButtonRect = Better_Work_Tab.RectCompat.Zero;
            _rememberChoiceRect = Better_Work_Tab.RectCompat.Zero;
            _chooserRememberChoice = true;

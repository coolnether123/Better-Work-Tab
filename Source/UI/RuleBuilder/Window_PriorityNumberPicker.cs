...
namespace Better_Work_Tab.UI.RuleBuilder
{
    public class Window_PriorityNumberPicker : Window
    {
        ...
        private static Vector2 PickerSize => new Vector2(460f, 380f);

#if v0_13
        public override Vector2 InitialWindowSize => PickerSize;
#else
        public override Vector2 InitialSize => PickerSize;

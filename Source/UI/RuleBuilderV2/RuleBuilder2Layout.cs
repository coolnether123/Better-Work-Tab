...
namespace Better_Work_Tab.UI.RuleBuilderV2
{
    ...
    internal sealed class RuleBuilder2Layout
    {
        ...
        internal RuleBuilder2HeaderRects Header(Rect rect)
        {
            ...
            Rect preview = Better_Work_Tab.RectCompat.Zero;
        ...
        {
            Rect inner = rect.ContractedBy(metrics.OuterPadding);
            Rect title = Better_Work_Tab.RectCompat.Zero;
            ...
            Rect overview = Better_Work_Tab.RectCompat.Zero;
        ...
        internal RuleBuilder2TargetSectionRects TargetSection(Rect rect, bool hasTarget)
        {
            ...
            if (hasTarget)
            {
                ...
                Rect hint = Better_Work_Tab.RectCompat.Zero;
                Rect next = Better_Work_Tab.RectCompat.Zero;
                return new RuleBuilder2TargetSectionRects(inner, summary, change, hint, next, Better_Work_Tab.RectCompat.Zero, Better_Work_Tab.RectCompat.Zero);
            }
            ...
            return new RuleBuilder2TargetSectionRects(inner, Better_Work_Tab.RectCompat.Zero, Better_Work_Tab.RectCompat.Zero, Better_Work_Tab.RectCompat.Zero, Better_Work_Tab.RectCompat.Zero, searchOrSummary, list);
        }

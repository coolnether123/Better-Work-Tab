...
namespace Better_Work_Tab.UI.RuleBuilderV2
{
    ...
    internal static class RuleBuilder2WorkTabBridge
    {
        ...
        {
            return activeWindow?.RuleBuilderWindowRect.Contains(UiCompat.MousePositionOnUIInverted) == true;
        }
        ...
        private static Rect ResolveCurrentTargetBounds(Rect fallback)
        {
            ...
            if (activeWindow != null &&
                ...
                MainTabCompat.OpenTabWindow is Better_Work_Tab.UI.MainTabWindow_BetterWork workTab &&
                workTab.TryGetRuleBuilder2TargetHeaderBounds(workType, workGiver, out Rect bounds))
            {
                return bounds;
            }

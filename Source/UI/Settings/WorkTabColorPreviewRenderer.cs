...
namespace Better_Work_Tab.UI.Settings
{
    ...
    internal static class WorkTabColorPreviewRenderer
    {
        ...
        {
            Better_Work_Tab.WidgetsCompat.DrawBoxSolid(new Rect(rect.xMin, rect.yMin, rect.width, thickness), color);
            Better_Work_Tab.WidgetsCompat.DrawBoxSolid(new Rect(rect.xMin, rect.yMax - thickness, rect.width, thickness), color);
            Better_Work_Tab.WidgetsCompat.DrawBoxSolid(new Rect(rect.xMin, rect.yMin, thickness, rect.height), color);
            Better_Work_Tab.WidgetsCompat.DrawBoxSolid(new Rect(rect.xMax - thickness, rect.yMin, thickness, rect.height), color);
        }
        ...
        private static void DrawLegend(Rect windowRect, WorkTabColorPreview preview)
        {
            ...
            Better_Work_Tab.WidgetsCompat.DrawBoxSolid(legend, new Color(0.035f, 0.04f, 0.045f, 0.96f));
            DrawBorder(legend, preview.Color, 2f);

            Rect swatch = new Rect(legend.x + 7f, legend.y + 6f, 18f, 18f);
            Better_Work_Tab.WidgetsCompat.DrawBoxSolid(swatch, preview.Color);

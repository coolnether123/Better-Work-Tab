...
namespace Better_Work_Tab.UI.Settings
{
    ...
    public static class BWTSettingsImportExportActions
    {
        ...
        private static void ExportToClipboard(BetterWorkTabSettings settings)
        {
            ...
            Messages.Message("Better Work Tab settings copied to clipboard.", MessageTypeDefOf.PositiveEvent, false);
        }
            ...
            Find.WindowStack.Add(new Dialog_BWTSettingsJsonPath(
                ...
                path =>
                {
                    try
                    {
                        ...
                        Messages.Message($"Better Work Tab settings exported to {path}.", MessageTypeDefOf.PositiveEvent, false);
                    }
                    catch (Exception ex)
                    {

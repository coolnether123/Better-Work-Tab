    ...
    public static class BWTSettingsRegistry
    {
            ...
            bool disabled)
        {
            ...
            if (Widgets.ButtonText(buttonRect, GetSubWorkTransitionModeLabel(settings)))
            {
                ...
                {
                    [offOption] = "Turns the sub-work transition animation off. Columns change immediately when entering or leaving the sub-work view.",
                    [classicOption] = "Uses BWT's original transition: columns glide into position with a brief flash while entering or leaving the sub-work view.",
                    [pixelOption] = "Keeps the columns in place while a grey pixel wave passes across them, progressively revealing or hiding the sub-work view."
                };
        ...
        private static void RegisterAllSettings()
        {
            ...
            Register(new SettingDefinition
            {
                ...
                Tooltip = "Modifier key used with the mouse button below to open or leave the sub-work view.",
            ...
            Register(new SettingDefinition
            {
                ...
                Tooltip = "Mouse button used with the modifier key above to open or leave the sub-work view.",
                Type = SettingType.Enum,
            ...
            Register(new SettingDefinition
            {
                ...
                Tooltip = "Drag a sub-work job onto another Work column to move it there. Turning this off limits dragging to the current sub-work view.",
                Type = SettingType.Bool,
            ...
            Register(new SettingDefinition
            {
                ...
                Tooltip = "Use smaller priority boxes when sub-work jobs expand beside their parent Work column. Focused full-tab view always uses normal-size boxes.",
            ...
            Register(new SettingDefinition
            {
                ...
                Tooltip = "After leaving from a sub-work header, move the cursor back to the Work header used to open it.",
                Type = SettingType.Bool,
            ...
            Register(new SettingDefinition
            {
                ...
                Tooltip = "After leaving from a pawn priority cell, move the cursor back to the Work header used to open the sub-work view. Turning this off leaves the cursor where you clicked.",
                Type = SettingType.Bool,
            ...
            Register(new SettingDefinition
            {
                ...
                Tooltip = "Show a short break-and-fade effect when returning a pawn's sub-work priority to the shared priority.",
                Type = SettingType.Bool,
            ...
            Register(new SettingDefinition
            {
                ...
                Tooltip = "Animate sub-work views, including Fluffy-style expand-beside columns and header text fade when they open or collapse.",
                Type = SettingType.Bool,
            ...
            Register(new SettingDefinition
            {
                ...
                Tooltip = "Choose how the Work tab opens sub-work jobs. Off changes instantly with no transition.",
            ...
            Register(new SettingDefinition
            {
                ...
                Tooltip = "Controls how quickly the Work tab opens, expands, collapses, or leaves sub-work jobs.",
            ...
            Register(new SettingDefinition
            {
                ...
                Tooltip = "Choose whether locked sub-work priorities can still run when their parent Work type is disabled. Multiplayer always uses vanilla parent-disable behavior.",
            ...
            Register(new SettingDefinition
            {
                ...
                Tooltip = "Use empty table width for sub-work columns so long labels fit without changing the pawn-name column.",
                Type = SettingType.Bool,
            ...
            Register(new SettingDefinition
            {
                ...
                Tooltip = "Give expanded sub-work columns equal widths. Turning this off widens only columns whose labels need more room.",
                Type = SettingType.Bool,
            ...
            Register(new SettingDefinition
            {
                ...
                Tooltip = "Allow renamed Work columns and sub-work jobs to appear in the Work tab. Off keeps saved names but shows default names.",
                Type = SettingType.Bool,

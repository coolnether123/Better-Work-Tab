    ...
    public static class BWTSettingsRegistry
    {
        ...
        private static void RegisterAllSettings()
        {
            ...
            Register(new SettingDefinition
            {
                ...
                Tooltip = "Show priority numbers in green at or above this percentage of the maximum priority.",
                Type = SettingType.Int,
            ...
            Register(new SettingDefinition
            {
                ...
                Tooltip = "Show priority numbers in yellow at or above this percentage of the maximum priority.",
                Type = SettingType.Int,
            ...
            Register(new SettingDefinition
            {
                ...
                Tooltip = "Show priority numbers in tan at or above this percentage of the maximum priority.",
                Type = SettingType.Int,
            ...
            Register(new SettingDefinition
            {
                ...
                Label = "Skill number: levels 0-3",
                Tooltip = "Text color of skill-level numbers from 0 through 3 inside Work priority cells.",
                Type = SettingType.Color,
            ...
            Register(new SettingDefinition
            {
                ...
                Label = "Skill number: levels 4-9",
                Tooltip = "Text color of skill-level numbers from 4 through 9 inside Work priority cells.",
                Type = SettingType.Color,
            ...
            Register(new SettingDefinition
            {
                ...
                Label = "Skill number: levels 10-15",
                Tooltip = "Text color of skill-level numbers from 10 through 15 inside Work priority cells.",
                Type = SettingType.Color,
            ...
            Register(new SettingDefinition
            {
                ...
                Label = "Skill number: levels 16+",
                Tooltip = "Text color of skill-level numbers at 16 or higher inside Work priority cells.",
                Type = SettingType.Color,

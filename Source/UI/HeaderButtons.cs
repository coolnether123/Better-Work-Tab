...
namespace Better_Work_Tab.UI
{
    ...
    public static class HeaderButtons
    {
            ...
            string fallbackLabel)
        {
            ...
            {
                clicked = Better_Work_Tab.WidgetsCompat.ButtonImage(rect, texture, Color.white, GenUI.MouseoverColor);
            }
            else
            {
                TextAnchor previousAnchor = Text.Anchor;
                Text.Anchor = TextAnchor.MiddleCenter;
                clicked = Better_Work_Tab.WidgetsCompat.ButtonText(rect, fallbackLabel);
        ...
        private static void ToggleManualPriorities(bool enabled)
        {
            ...
            foreach (Pawn pawn in PawnsFinderCompat.AllAlive)
            {
